...
Este é um jogo simples onde o jogador deve se mover e desviar dos inimigos na tela, desenvolvido como parte do tutorial ["Your first 2D game"](https://docs.godotengine.org/en/latest/getting_started/first_2d_game/index.html), na documentação oficial da Godot.

## Links importantes

- [Godot](https://godotengine.org/) (Game Engine)
- [GDScript](https://docs.godotengine.org/en/stable/tutorials/scripting/gdscript/gdscript_basics.html) (Linguagem)
- ["Your first 2D game"](https://docs.godotengine.org/en/latest/getting_started/first_2d_game/index.html) (Tutorial)
